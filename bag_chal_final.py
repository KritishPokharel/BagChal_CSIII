...
class Board:
    def draw(self, screen):
        ...
        wood_texture = pygame.image.load('images/wood.png')
    ...
    def draw_music_button(self, screen, music_playing):
        if music_playing:
            music_btn = pygame.image.load('images/icons8-speaker-50.png')  # Load the music on image
        else:
            music_btn = pygame.image.load('images/icons8-mute-50.png')  # Load the music off image
    ...
    def draw_atiger(self, screen):
        #draw selected tiger
        active_tiger = pygame.image.load('images/tiger.png')
        if temp_tiger:
            screen.blit(active_tiger, temp_tiger[0])

    def draw_agoat(self, screen):
	    #draw selected goat
        active_goat = pygame.image.load('images/goat.png')
        if temp_goat:
    ...
    def play_move(self):
        ...
        # Load sound effects
        move_sound_effect = pygame.mixer.Sound('sounds/move.mp3')
    ...
    def goat_killed(self):
        #play sound on every move
        # Load sound effects
        goat_killed_sound = pygame.mixer.Sound('sounds/goat_scream.mp3')
        # To play a sound effect
...
def main():
    ...
    music_playing = True  
    pygame.mixer.music.load('sounds/morphed-metal-discharged-cinematic-trailer-sound-effects-124763.mp3')
    ...
    music_on_img = pygame.image.load('images/icons8-speaker-50.png')
    music_off_img = pygame.image.load('images/icons8-mute-50.png')
        ...
        for event in pygame.event.get():
            ...
            if event.type == pygame.MOUSEBUTTONDOWN and start == False and game_help == False: #start the game when user clicks start button when start is False, help is False
                ...
                if column >= 640 and column <=790 and row >=60 and row <=100:
                    ...
                    pygame.mixer.music.load("sounds/horror-chase-music-loop-67634.mp3")
